...
def birthday_song(name):
  print(f"Happy birthday to you! Happy birthday to you! Happy birthday dear {name}, happy brithday to you!")
...
def five_cards():
  return f"{random.choice(card)} {random.choice(suit)}"



def card_pick(card):
  print(f"The cards I pick are {five_cards()}, {five_cards()}, {five_cards()}, {five_cards()}, and {five_cards()}! ")
